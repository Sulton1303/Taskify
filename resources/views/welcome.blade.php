...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <span>Kontak</span>
        <h2>Kontak</h2>
        <p>Berikut adalah kontak yang dapat dihubungi</p>
      </div><!-- End Section Title -->
          ...
          <div class="col-xl-12">
            ...
            <div class="info-wrap">
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h3>Alamat</h3>
                  <p>Karanganyar, Klari, Karawang, Jawa Barat 41371</p>
                </div>
              </div><!-- End Info Item -->
              ...
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="400">
                ...
                <div>
                  <h3>Email</h3>
                  <p>mhammadslton46@gmail.com</p>
                </div>
              </div><!-- End Info Item -->

              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.4410426345476!2d107.38296917355807!3d-6.465677663216377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e690dd32823ef83%3A0xe88cff22dd93054f!2sMASTER%20BAJA!5e0!3m2!1sen!2sid!4v1766406791524!5m2!1sen!2sid" frameborder="0" style="border:0; width: 100%; height: 270px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Taskify</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you've purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
        Designed by <a href="https://github.com/Sulton1303/Taskify">Muhammad Sulton</a>
      </div>
    </div>
